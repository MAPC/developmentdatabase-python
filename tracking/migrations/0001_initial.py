...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Note'
        db.create_table('tracking_note', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('town', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Town'])),
            ...
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.UserProfile'], null=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('tracking', ['Note'])


    def backwards(self, orm):
        
        # Deleting model 'Note'
        db.delete_table('tracking_note')
    ...
    models = {
        'accounts.userprofile': {
            ...
            'town': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.Town']"}),
        ...
        'tracking.note': {
            ...
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.UserProfile']", 'null': 'True', 'blank': 'True'}),
