...
class Project(models.Model):
    ...
    type_id = models.ForeignKey("Project Type (DvtType)", TypeChoice, blank=True, null=True)
    type_detail = models.TextField("Project Type Detail", blank=True, null=True)
    status_id = models.ForeignKey("Project Status (Status)", StatusChoice, blank=True, null=True)
    ...
    created_by = models.ForeignKey("Added By", User, editable=False, related_name="project_created_by", blank=True, null=True)
    create_date = models.DateTimeField("Create Date", editable=False, auto_now=True)
    last_updated_by = models.ForeignKey("Last updated by", User, related_name="project_last_updated_by", blank=True, null=True)
    ...
    zoning_tool_id = models.ForeignKey("Zoning Tool (Ch40)", ZoningChoice, blank=True, null=True)
