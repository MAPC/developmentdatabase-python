...
class ZoningTool(models.Model):
    z_type = models.CharField('Type', max_length=5)
    description = models.TextField(blank=True, null=True)


class ProjectType(models.Model):
    p_type = models.CharField('Type', max_length=50)
...
class Project(models.Model):
    ...
    name = models.CharField('Project Name (DDname)', max_length=255)
    description = models.TextField('Project Description ', blank=True, null=True)
    p_type = models.ForeignKey(ProjectType, blank=True, null=True, help_text="Project Type (DvtType)")
    p_type_detail = models.TextField('Project Type Detail', blank=True, null=True)
    status = models.ForeignKey(ProjectStatus, blank=True, null=True, help_text="Project Status (Status)")
    ...
    last_updated_by = models.ForeignKey(User, related_name='project_last_updated_by', blank=True, null=Truehelp_text="Last Updated By")
    ...
    age_restricted_pct = models.CharField('Percent Age Restricted (Ovr55)', max_length=1, blank=True, null=True, choices=YESNO_CHOICES)
    ...
    redevelopment = models.CharField('Redevelopment (Rdv)', max_length=1, blank=True, null=True, choices=YESNO_CHOICES)
    cluster_subdivision = models.CharField('Cluster Subdivision (ClustOSRD)', max_length=1, blank=True, null=True, choices=YESNO_CHOICES)
    zoning_tool = models.ForeignKey(ZoningTool, blank=True, null=True, help_text="Zoning Tool (Ch40)")
    as_of_right = models.TextField('As-of-Right', blank=True, null=True)
    mixed_use = models.CharField('Mixed use project (MxdUse)', max_length=1, blank=True, null=True, choices=YESNO_CHOICES)
    ...
    # legacy fields, to be evaluated and then removed or merged into new fields
    legacy_status = models.CharField('Legacy: Status', max_length=255, blank=True, null=True, help_text='Completed, Under Construction, Planning, or Projected')
    legacy_mf_hu = models.FloatField('Legacy: Housing units after discounting', blank=True, null=True)
    legacy_ch40 = models.CharField('Legacy: 40B/40R/43D', max_length=255, blank=True, null=True, help_text='Indicates use of Chapter 40B (Comprehensive Permit law), 40R (Smart Growth Zoning), or 43D (Expedited Permitting)')
    legacy_totempl = models.FloatField('Legacy: Total Employment Potential', blank=True, null=True, help_text='MAPC estimates of total potential employment based on reported employment, square footage, and standard employment density factors')
    legacy_mf_empl = models.FloatField('Legacy: Discounted Employment', blank=True, null=True, help_text='Total employment after applying discount factor to projects not yet completed, MetroFuture Scenario')
    legacy_dvttype = models.CharField('Legacy: Type of Project', max_length=255, blank=True, null=True)
    legacy_mftot00_10 = models.FloatField('Legacy: Employment 2000 - 2010', blank=True, null=True)
    legacy_mftot10_20 = models.FloatField('Legacy: Employment 2010 - 2020', blank=True, null=True)
    legacy_mftot20_30 = models.FloatField('Legacy: Employment 2020 - 2030', blank=True, null=True)
    legacy_mftot30_35 = models.FloatField('Legacy: Employment 2030 - 2035', blank=True, null=True)
    legacy_mfhu00_10 = models.FloatField('Legacy: Housing Units 2000 - 2010', blank=True, null=True)
    legacy_mfhu10_20 = models.FloatField('Legacy: Housing Units 2010 - 2020', blank=True, null=True)
    legacy_mfhu20_30 = models.FloatField('Legacy: Housing Units 2020 - 2030', blank=True, null=True)
    legacy_mfhu30_35 = models.FloatField('Legacy: Housing Units 2030 - 2035', blank=True, null=True)
    legacy_mfgq00_10 = models.FloatField('Legacy: Group Quarters 2000 - 2010', blank=True, null=True)
    legacy_mfgq10_20 = models.FloatField('Legacy: Group Quarters 2010 - 2020', blank=True, null=True)
    legacy_mfgq20_30 = models.FloatField('Legacy: Group Quarters 2020 - 2030', blank=True, null=True)
    legacy_mfgq30_35 = models.FloatField('Legacy: Group Quarters 2030 - 2035', blank=True, null=True)
