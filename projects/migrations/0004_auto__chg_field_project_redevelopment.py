...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.redevelopment'
        db.alter_column('projects_project', 'redevelopment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))


    def backwards(self, orm):
        
        # Changing field 'Project.redevelopment'
        db.alter_column('projects_project', 'redevelopment', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'projects.project': {
            ...
            'taz': ('django.db.models.fields.IntegerField', [], {}),
