...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.create_date'
        db.alter_column('projects_project', 'create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'Project.create_date'
        db.alter_column('projects_project', 'create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
