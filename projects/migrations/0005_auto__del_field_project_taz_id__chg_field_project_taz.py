...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Project.taz' to match new field type.
        db.rename_column('projects_project', 'taz', 'taz_id')
        # Changing field 'Project.taz'
        db.alter_column('projects_project', 'taz_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Taz'], null=True))

        # Adding index on 'Project', fields ['taz']
        db.create_index('projects_project', ['taz_id'])


    def backwards(self, orm):
        
        # Removing index on 'Project', fields ['taz']
        db.delete_index('projects_project', ['taz_id'])
        ...
        # Renaming column for 'Project.taz' to match new field type.
        db.rename_column('projects_project', 'taz_id', 'taz')
        # Changing field 'Project.taz'
        db.alter_column('projects_project', 'taz', self.gf('django.db.models.fields.IntegerField')(default=0))
