...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.website'
        db.alter_column('projects_project', 'website', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'Project.website_add'
        db.alter_column('projects_project', 'website_add', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))
    def backwards(self, orm):

        # Changing field 'Project.website'
        db.alter_column('projects_project', 'website', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Project.website_add'
        db.alter_column('projects_project', 'website_add', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    models = {
        'auth.group': {
