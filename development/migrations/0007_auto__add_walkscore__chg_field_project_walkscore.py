...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WalkScore'
        db.create_table('development_walkscore', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')()),
            ('walkscore', self.gf('django.db.models.fields.IntegerField')()),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('ws_link', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('snapped_lat', self.gf('django.db.models.fields.FloatField')()),
            ('snapped_lon', self.gf('django.db.models.fields.FloatField')()),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True)),
        ))
        db.send_create_signal('development', ['WalkScore'])


        # Renaming column for 'Project.walkscore' to match new field type.
        db.rename_column('development_project', 'walkscore', 'walkscore_id')
        # Changing field 'Project.walkscore'
        db.alter_column('development_project', 'walkscore_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['development.WalkScore'], null=True))
        # Adding index on 'Project', fields ['walkscore']
        db.create_index('development_project', ['walkscore_id'])


    def backwards(self, orm):
        # Removing index on 'Project', fields ['walkscore']
        db.delete_index('development_project', ['walkscore_id'])

        # Deleting model 'WalkScore'
        db.delete_table('development_walkscore')


        # Renaming column for 'Project.walkscore' to match new field type.
        db.rename_column('development_project', 'walkscore_id', 'walkscore')
        # Changing field 'Project.walkscore'
        db.alter_column('development_project', 'walkscore', self.gf('django.db.models.fields.IntegerField')(null=True))
