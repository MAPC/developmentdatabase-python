...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.dd_id_tmp'
        db.delete_column('development_project', 'dd_id_tmp')


    def backwards(self, orm):
        # Adding field 'Project.dd_id_tmp'
        db.add_column('development_project', 'dd_id_tmp',
