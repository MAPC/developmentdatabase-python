...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Parcel.est_employment'
        db.execute("ALTER TABLE development_project ADD COLUMN est_employment numeric")
        # db.add_column('development_parcel', 'est_employment',
        #               self.gf('django.db.models.fields.FloatField')(null=True),
        #               keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Parcel.est_employment'
        db.delete_column('development_project', 'est_employment')
