...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # print "The following projects have nonzero estimated employments:\n\n\n"
        # for project in orm['development.Project'].objects.filter(est_employment__gt=0): print(project.ddname)
        for project in Project.objects.all(): project.save()
        print "The following projects have nonzero estimated employments:\n\n\n"
        for project in Project.objects.filter(est_employment__gt=0): print(project.ddname)

    def backwards(self, orm):
        db.execute("UPDATE development_project SET est_employment = NULL")
    ...
    models = {
        ...
        'development.parcel': {
            'Meta': {'ordering': "['gid']", 'object_name': 'Parcel'},
        ...
        'development.project': {
            ...
            'est_employment': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
