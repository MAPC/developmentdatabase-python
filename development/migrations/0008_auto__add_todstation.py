...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TODStation'
        db.create_table('development_todstation', (
            ...
            ('subway', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('comrail', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('taz', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['development.Taz'])),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')()),
        ))
        db.send_create_signal('development', ['TODStation'])


    def backwards(self, orm):
        # Deleting model 'TODStation'
        db.delete_table('development_todstation')
