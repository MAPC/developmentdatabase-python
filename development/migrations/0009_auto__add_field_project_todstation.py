...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.todstation'
        db.add_column('development_project', 'todstation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['development.TODStation'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.todstation'
        db.delete_column('development_project', 'todstation_id')
